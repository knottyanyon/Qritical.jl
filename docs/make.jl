...
makedocs(;
    ...
    plugins=[bib], pages=[
        ...
        "ADR" => [
            ...
            "ADR 0005 — SVD truncation tracking" => "adr/0005-svd-truncation-tracking.md",
            "ADR 0006 — Schmidt spectrum type" => "adr/0006-schmidt-spectrum-type.md",
            "ADR 0007 — MPS type" => "adr/0007-mps-type.md",
        ],
