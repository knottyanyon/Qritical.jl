...
````
vidal_correlation_nn (generic function with 1 method)
````
...
````
⟨σᶻᵢ σᶻᵢ₊₁⟩: [-58.33, 3714.0, -1.063e6, 3.619e7, -7.074e10, 1.459e13, 7.268e14, 3.616e16, 1.798e6]
...
⟨σᶻᵢ σᶻᵢ₊₁⟩_connected: [-14.94, 1362.0, -434800.0, 1.385e8, -5.458e10, 1.217e13, 1.517e15, 7.377e16, -2.15e8]
