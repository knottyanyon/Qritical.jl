...
````
mixed_canonical_mps (generic function with 1 method)
````
...
````
check_mixed_isometry (generic function with 1 method)
````
...
````
  l = 1:  center shape = (1, 2, 2)   ‖C‖ = 1.0
  l = 3:  center shape = (4, 2, 8)   ‖C‖ = 1.0
  l = 5:  center shape = (16, 2, 32)   ‖C‖ = 1.0
  l = 10:  center shape = (2, 2, 1)   ‖C‖ = 1.0
...
Before move_center!: Qritical.CanonicalForm(10, 11)
After  move_center! (l=5): Qritical.CanonicalForm(4, 6)
  ⟨ψ|ψ⟩ preserved: 1.0
  Entanglement entropy at bond 5 : 1.5698 nats
