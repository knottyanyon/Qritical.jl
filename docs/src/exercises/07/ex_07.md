...
````
After odd+even sweep ⟨ψ|ψ⟩ = 249.30753
...
````
1st-order Trotter ⟨ψ|ψ⟩ = 249.30753
...
````
2nd-order Trotter ⟨ψ|ψ⟩ = 249.30753
...
Energy before evolution:        2.0451367
After 1st-order Trotter step:   2.0669535  ΔE=0.0218
After 2nd-order Trotter step:   2.0455781  ΔE=0.000441
