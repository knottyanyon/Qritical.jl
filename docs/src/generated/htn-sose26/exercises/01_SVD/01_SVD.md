```@meta
EditURL = "../../../../htn-sose26/exercises/01_SVD/01_SVD.jl"
```
...
## 2. SVD a state
Perform an SVD on the state psi.jls given in Moodle. The format is a tensor of rank 10, dimensions 210 = 1024.
