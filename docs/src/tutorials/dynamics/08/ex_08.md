...
```@raw html
<iframe
  src="../../../../assets/interactives/tebd_explorer.html"
  style="width:100%;height:440px;border:none;border-radius:10px;margin:1.5rem 0;display:block;"
  title="TEBD Néel quench — interactive D and dt explorer"
></iframe>
```
