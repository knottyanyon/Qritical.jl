...
#     <p style="text-align:center; margin: 0.5rem 0 0.3rem;">
#       \[ A = U \Sigma V^\dagger \]
#     </p>
#     <p style="text-align:center; margin: 0 0 0.5rem; font-size:0.93em;">
#       \[ A_{ij} \;=\; \sum_{k=1}^{r} \sigma_k \; U_{ik} \; V^*_{jk} \]
#     </p>
#     <p style="text-align:center; margin:0; font-size:0.82em; color:#6c757d;">
#       \(U \in \mathbb{C}^{m \times r}\) has orthonormal columns,
#       \(\Sigma = \operatorname{diag}(\sigma_1 \geq \cdots \geq \sigma_r > 0)\),
#       \(V \in \mathbb{C}^{n \times r}\) has orthonormal columns.
#     </p>
#   </div>
#   <div class="tn-repr-diag">
#     <img src="../1_light.svg" class="docs-light-only" style="max-width:100%"/>
#     <img src="../1_dark.svg"  class="docs-dark-only"  style="max-width:100%"/>
#   </div>
# </div>
# ```
#
